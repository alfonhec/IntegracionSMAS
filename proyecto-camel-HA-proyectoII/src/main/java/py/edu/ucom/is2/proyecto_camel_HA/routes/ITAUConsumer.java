...
public class ITAUConsumer extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("activemq:alfonzo-ITAU-IN")
            .log("Mensaje recibido en Consumer Banco ITAU: ${body}")
            ...
            .choice()
                ...
                .otherwise()
                    .process(exchange -> {
                        ...
                        respuesta.put("mensaje", "Transferencia procesada exitosamente desde CONSUMERITAU");
                        ObjectMapper objectMapper = new ObjectMapper();
                        String jsonRespuesta = objectMapper.writeValueAsString(respuesta);
                        exchange.getIn().setBody(jsonRespuesta);
                    })
                    .log("Transferencia aceptada desde CONSUMERITAU: ${body}")
            .end();
    }
}
